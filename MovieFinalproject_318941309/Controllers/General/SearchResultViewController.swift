...
class SearchResultViewController: UIViewController {
    ...
    public let serchResultsCollectionView: UICollectionView = {
    ...
    override func viewDidLoad() {
        ...
        view.addSubview(serchResultsCollectionView)
        serchResultsCollectionView.delegate = self
        serchResultsCollectionView.dataSource = self
    }
    override func viewDidLayoutSubviews() {
        super.viewDidLayoutSubviews()
        serchResultsCollectionView.frame = view.bounds
    }
